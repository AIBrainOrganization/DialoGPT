python -u train_reinforce.py --train_input_file data/reinforce/acryl_no_neutral/train.200len.2turn.db --eval_input_file data/reinforce/acryl_no_neutral/valid.200len.2turn.db --output_dir ./models/reinforce/acryl_no_neutral --seed 42 --max_seq_length 200 --train_batch_size 512 --gradient_accumulation_steps 8 --eval_batch_size 64 --learning_rate 1e-5 --num_optim_steps 643 --valid_step 16 --warmup_steps 16 --normalize_data true --fp16 false --lr_schedule noam --loss_scale 0.0 --no_token_id true --pbar true
